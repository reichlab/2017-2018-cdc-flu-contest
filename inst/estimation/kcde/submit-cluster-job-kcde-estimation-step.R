...
#          for(season_left_out in all_seasons_left_out) {
            save_path <- "/home/er71a/2017-2018-cdc-flu-contest/inst/estimation/kcde/fits"
            output_path <- "/home/er71a/2017-2018-cdc-flu-contest/inst/estimation/kcde/cluster-output"
...
#                       season_left_out, " ",
                       first_test_season, " ",
                       save_path,
                       "\'  /home/er71a/2017-2018-cdc-flu-contest/inst/estimation/kcde/kcde-estimation-step.R ",
